...
public class NvidiumCompactChunkVertex implements ChunkVertexType {
    ...
    public ChunkVertexEncoder getEncoder() {
        //Sodium 0.5.13 hands the encoder a whole quad (Vertex[4]) per call and expects the
        //returned pointer to be advanced past every vertex written (was one Vertex per call in
        //0.5.11). Encode each of the quad's vertices with the same compact 16-byte layout.
